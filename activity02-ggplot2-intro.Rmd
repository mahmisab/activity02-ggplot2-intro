...
**Response**: Within a boxplot, you can easily identify the statistics of the data like the median, range, max, min, and outliers if the data has any. With the jitterplot, you can easily see all data points. 
